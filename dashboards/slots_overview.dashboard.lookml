...
- dashboard: slots_overview
  ...
  - title: Time Series Job Count
    ...
    type: looker_area
    fields: [jobs_timeline_by_project.job_count, jobs_timeline_by_project.total_gb_processed,
      jobs_timeline_by_project.total_period_slot_seconds, jobs_timeline_by_project.max_period_slot_seconds,
      jobs_timeline_by_project.period_start_from_parameter]
    ...
    totals_color: "#808080"
    defaults_version: 1
    hidden_fields: [jobs_timeline_by_project.total_period_slot_seconds, jobs_timeline_by_project.max_period_slot_seconds,
      jobs_timeline_by_project.total_gb_processed]
    listen:
  ...
  - title: Time Series Max Slots
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: jobs_timeline_by_project.total_period_slot_seconds,
            id: jobs_timeline_by_project.total_period_slot_seconds, name: Total Slots}],
        showLabels: true, showValues: true, unpinAxis: false, tickDensity: default,
        tickDensityCustom: 5, type: linear}, {label: !!null '', orientation: right,
        series: [{axisId: jobs_timeline_by_project.max_period_slot_seconds, id: jobs_timeline_by_project.max_period_slot_seconds,
            name: Max Slots}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear}]
    x_axis_zoom: true
    y_axis_zoom: true
    series_colors:
      jobs_timeline_by_project.max_period_slot_seconds: "#E8710A"
    defaults_version: 1
    hidden_fields: [jobs_timeline_by_project.job_count, jobs_timeline_by_project.total_gb_processed,
  ...
  - title: Time Series Total Slots
    ...
    series_colors:
      jobs_timeline_by_project.max_period_slot_seconds: "#E8710A"
      jobs_timeline_by_project.total_period_slot_seconds: "#F9AB00"
    defaults_version: 1
    hidden_fields: [jobs_timeline_by_project.job_count, jobs_timeline_by_project.total_gb_processed,
      jobs_timeline_by_project.max_period_slot_seconds]
    listen:
      Period Start Time: jobs_timeline_by_project.period_start_time
      Region: parameters.region
      Project Name: parameters.project_name
  ...
  - title: Time Series GB Processed
    ...
    y_axis_zoom: true
    series_colors:
      jobs_timeline_by_project.total_gb_processed: "#7CB342"
    defaults_version: 1
    hidden_fields: [jobs_timeline_by_project.total_period_slot_seconds, jobs_timeline_by_project.max_period_slot_seconds,
